...
const props = [
  ...
  },
  {
    ...
    body: "Guided Quote → Sign path, then attribute. Wallet adapter + server-side API key proxy.",
  },
  {
    title: "Book & claims",
    body: "Positions from GET /positions with mark notionals, win and creator-fee claims in-wallet.",
  },
];
    ...
    <div className="animate-fade-in">
      <section className="relative overflow-hidden border-b border-[#1f1f23] pb-10 pt-8 md:pb-14 md:pt-12">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/5 px-3 py-1 text-[11px] text-cyan-200/90">
            <span className="live-dot h-1.5 w-1.5 rounded-full bg-emerald-400" />
            Solana prediction desk · Powered by Panta
          </div>
          <h1 className="text-[2.5rem] font-semibold tracking-tight text-zinc-50 md:text-5xl md:leading-[1.08]">
            Trade the market.
            <br />
          ...
          <p className="mt-3 flex flex-wrap items-center justify-center gap-2 text-[12px] text-zinc-500">
            <Link
              href="/desk"
      ...
      {/* Single CTA — no duplicate band */}
      <section className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[#1f1f23] bg-[#111113] px-5 py-4">
        <div>
